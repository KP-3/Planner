...
//     System.out.println(theCurrentState);
 ...
 private int planningAGoal(String theGoal,Vector<WorkingMemory> theCurrentState,
...
//		goalList.add("A on E");
 ...
 private Vector initInitialState(){
  ...
  initialState.addElement(new WorkingMemory("clear A",mTimetag));
  initialState.addElement(new WorkingMemory("clear B",mTimetag));
  initialState.addElement(new WorkingMemory("clear C",mTimetag));

  initialState.addElement(new WorkingMemory("ontable A",mTimetag));
  initialState.addElement(new WorkingMemory("ontable B",mTimetag));
  initialState.addElement(new WorkingMemory("ontable C",mTimetag));
  initialState.addElement(new WorkingMemory("handEmpty",mTimetag));
//     		initialState.add(new WorkingMemory("clear A", mTimetag));
//		initialState.add(new WorkingMemory("clear B",mTimetag));
//		initialState.add(new WorkingMemory("ontable C", mTimetag));
//		initialState.add(new WorkingMemory("A on C", mTimetag));
//		initialState.add(new WorkingMemory("E on D", mTimetag));
//		initialState.add(new WorkingMemory("F on E", mTimetag));
//
//		initialState.add(new WorkingMemory("B on F", mTimetag));
//		initialState.add(new WorkingMemory("ontable D", mTimetag));

//		initialState.add(new WorkingMemory("B on F", mTimetag));
//		initialState.add(new WorkingMemory("handEmpty",mTimetag));
  return initialState;
 }
